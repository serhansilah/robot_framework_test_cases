...
${phone}    phone
${password}    password
${audio_btn}     xpath://*[@id="top_audio"]
${audio_search}     xpath://*[@id="audio_search_layer"]
${audio}    Опера #2
*** Test Cases ***
Music search from button
   [tags]    success
    ...
    Sleep  4
    Click Button    ${audio_btn}
    Sleep  2
    Input Box    ${audio_search}    ${audio}
    Sleep  2
    Page Should Contain    ${audio} 
