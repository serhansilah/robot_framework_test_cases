...
${sidebar}    xpath://*[@id="sidebar-btn"]
${close_btn}    xpath://*[@class="yui3-button closebutton"]
*** Test Cases ***
Not registered course error
   [tags]    success
    ...
    Click Link  partial link:2020 - 2021 Spring
    Click Link    GR555E-202002
    Sleep  1
    Page Should Contain    requireloginerror
