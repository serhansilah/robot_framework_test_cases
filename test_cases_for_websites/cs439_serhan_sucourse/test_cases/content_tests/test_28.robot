...
${sidebar}    xpath://*[@class="userbutton"]
${close_btn}    xpath://*[@class="yui3-button closebutton"]
*** Test Cases ***
Badges
   [tags]    success
    ...
    Click Link  partial link:Osman Serhan Silahyürekli
    Click Link  partial link:Preferences
    Click Link  partial link:Manage badges
    Page Should Contain    There are no badges available. 
